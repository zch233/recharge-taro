...
var Record = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Record() {
    ...
    }, _this.$usedState = ["loopArray21", "orderList", "HFIcon", "LLIcon", "isLastPage", "status"], _this.anonymousFunc0Map = {}, _this.anonymousFunc1Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Record, [{
    ...
    value: function _createData() {
      ...
      var loopArray21 = orderList.map(function (order, __index0) {
        order = {
        ...
        var _$indexKey = "dizzz" + __index0;

        _this2.anonymousFunc0Map[_$indexKey] = function () {
          return payNow(order.$original);
        };

        var _$indexKey2 = "djzzz" + __index0;
