...
var UsedPhoneList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function UsedPhoneList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UsedPhoneList.__proto__ || Object.getPrototypeOf(UsedPhoneList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray47", "visible", "usedPhoneList", "onConfirm"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(UsedPhoneList, [{
    ...
    value: function _createData() {
      ...
      var loopArray47 = usedPhoneList.map(function (phone, __index0) {
        phone = {
