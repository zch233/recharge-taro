...
var CountryList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function CountryList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CountryList.__proto__ || Object.getPrototypeOf(CountryList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray31", "$compid__283", "$compid__284", "$compid__285", "currentCountry", "$anonymousCallee__5", "listVisible", "onClose", "countryList", "onConfirm"], _this.anonymousFunc1Map = {}, _this.customComponents = ["AtFloatLayout", "AtIcon", "AtInput"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(CountryList, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__284"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__284 = _genCompid4[0],
          $compid__284 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__285"),
      ...
      var _props = this.__props,
          ...
          _props$currentCountry = _props.currentCountry,
          currentCountry = _props$currentCountry === undefined ? {} : _props$currentCountry;
      ...
      var $anonymousCallee__5 = countryList.filter(function (v) {
        return v.searchKeyword.indexOf(searchValue.toLowerCase()) >= 0;
      });
      var loopArray31 = countryList.filter(function (v) {
        return v.searchKeyword.indexOf(searchValue.toLowerCase()) >= 0;
