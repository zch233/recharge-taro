...
var CountryList = (_temp2 = _class = function (_Taro$Component) {
  ...
  function CountryList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CountryList.__proto__ || Object.getPrototypeOf(CountryList)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray11", "$compid__53", "carrierList", "currentCarrier", "listVisible", "onClose", "onConfirm"], _this.anonymousFunc0Map = {}, _this.customComponents = ["AtFloatLayout", "AtIcon"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(CountryList, [{
    ...
    value: function _createData() {
      ...
      var loopArray11 = carrierList.map(function (carrier, __index0) {
        carrier = {
        ...
        var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "bizzzzzzzz" + __index0, true),
