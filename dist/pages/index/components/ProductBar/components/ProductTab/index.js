...
var ProductTab = (_temp2 = _class = function (_Taro$Component) {
  ...
  function ProductTab() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ProductTab.__proto__ || Object.getPrototypeOf(ProductTab)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__166", "$compid__167", "current", "index"], _this.customComponents = ["AtTabsPane", "ProductItem"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ProductTab, [{
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__166"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__166 = _genCompid2[0],
          $compid__166 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__167"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__167 = _genCompid4[0],
          $compid__167 = _genCompid4[1];
  ...
  return ProductTab;
}(_taroWeapp2.default.Component), _class.$$events = [], _class.$$componentPath = "pages/index/components/ProductBar/components/ProductTab/index", _temp2);
...
},[["./src/pages/index/components/ProductBar/components/ProductTab/index.jsx","runtime","vendors"]]]);