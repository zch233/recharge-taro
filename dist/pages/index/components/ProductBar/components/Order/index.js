...
var Order = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Order() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Order.__proto__ || Object.getPrototypeOf(Order)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__35", "$compid__36", "$compid__37", "$compid__38", "$compid__39", "orderVisible", "onClose"], _this.customComponents = ["AtFloatLayout", "AtIcon", "CouponList"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Order, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__36"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__36 = _genCompid4[0],
          $compid__36 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__37"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__37 = _genCompid6[0],
          $compid__37 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__38"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__38 = _genCompid8[0],
          $compid__38 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__39"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__39 = _genCompid10[0],
          $compid__39 = _genCompid10[1];
