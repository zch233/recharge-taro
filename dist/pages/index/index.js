...
var Index = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Index() {
    ...
    }, _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "$compid__122", "$compid__123"], _this.customComponents = ["OverHeader", "InputBar", "ProductBar"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__123"),
      ...
      _taroWeapp.propsManager.set({
        "setProductDisabled": anonymousState__temp,
        "setRequestProductData": anonymousState__temp2,
        "setInitTips": anonymousState__temp3
